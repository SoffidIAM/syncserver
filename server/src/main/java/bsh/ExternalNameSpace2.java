...
*/
public class ExternalNameSpace2 extends NameSpace
{
	private Map externalMap;

    public ExternalNameSpace2() 
	{
	...
	/**
	*/
    public ExternalNameSpace2( NameSpace parent, String name, Map externalMap ) 
	{
		super( parent, name );
	...
	*/
		...
		throws UtilEvalError
	{
		...
		if ( value == null ) 
		{
			// Do not remove variable. Delegate to master
